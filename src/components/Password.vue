...
<template>
  <div :class="containerClass" :style="style">
    <PInputText ref="input" :class="inputFieldClass" :style="inputStyle" :type="inputType" :modelValue="modelValue" @update:modelValue="onUpdate" @input="onInput" @focus="onFocus" @blur="onBlur" @keyup="onKeyUp" v-bind="$attrs" />
